...
|---|---|---|
| **Govern** | Definir políticas, responsabilidades, prioridades e critérios de decisão | <!-- TODO(Murillo) --> |
| **Identify** | Conhecer ativos, dependências, vulnerabilidades e riscos | <!-- TODO(Murillo) --> |
| **Protect** | Implementar salvaguardas para reduzir a probabilidade ou o impacto | <!-- TODO(Murillo) --> |
| **Detect** | Identificar eventos suspeitos, falhas e possíveis incidentes | <!-- TODO(Murillo) --> |
| **Respond** | Conter, analisar, comunicar e tratar incidentes | <!-- TODO(Murillo) --> |
| **Recover** | Restaurar serviços e dados e reduzir os prejuízos causados | <!-- TODO(Murillo) --> |
