...
| P2 | Preencher a URL real do repositório no README e nos dois documentos | Felipe | 06/08 | 🔴 |
| P3 | Informar o usuário do GitHub (Fernando ainda não enviou) | Fernando | 06/08 | 🔴 |
| P4 | Cada integrante confere `git config user.email` e faz um commit de teste | Todos | 06/08 | 🔴 |
| P5 | Ler o enunciado completo e este backlog | Todos | 06/08 | 🔴 |
...
|---|---|---|---|
| **Felipe** | Seções 1, 2 e revisão | Risco residual (16) e considerações finais (17) | Estrutura do repositório + fechamento |
...
| **Fernando** | — (apoio na revisão) | Critérios (8), consolidação do registro (9) e priorização (11) | Métrica e priorização de risco |
...
- [ ] Confirmar o nome do sistema — "SaborExpress" é uma proposta e pode ser trocado.
